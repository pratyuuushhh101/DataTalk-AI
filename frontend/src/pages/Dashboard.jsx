...
import {
    BarChart3, Mic, Shield, Cloud, Database,
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
                        <div className="text-center lg:text-left animate-fade-in-up">
                            ...
                            <p className="text-base lg:text-lg text-[#B5FF7D]/90 font-medium tracking-wide mb-2">
                                AI Business Intelligence for Indian MSMEs
                            </p>
                    ...
                    <div className="lg:col-span-8 flex flex-col">
                        {state.loading ? (
                            ...
                            <div className="space-y-0">
                                ...
                                <InsightSummary insight={state.insight} questionLanguage={detectedLang} />
                            ...
                            <div className="flex-1 bg-card-bg backdrop-blur-md rounded-2xl shadow-lg border border-card-border flex items-center justify-center p-12 min-h-[500px]">
                                <div className="text-center max-w-sm animate-fade-in">
                                    ...
                                    <p className="text-sm text-gray-500 leading-relaxed">
                                        {state.uploaded
                                            ? 'Ask a question in English, Hindi, or Bengali to generate insights, charts, and AI analysis from your business data.'
                                            : 'Upload a CSV or Excel dataset to begin analyzing your business data with multilingual queries.'
                                        }
                                    </p>
                                    {!state.uploaded && (
