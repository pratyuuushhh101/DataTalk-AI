                ...
                <section className="pt-32 pb-24 px-6 relative">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <p className="text-lg md:text-xl text-gray-400 mb-12 max-w-2xl mx-auto leading-relaxed">
                            Upload CSV data and ask questions in **English, Hindi, or Bengali**. Generate SQL, charts, and actionable AI insights in any language instantly.
                        </p>
                ...
                <section id="features" className="py-24 px-6 md:px-12 max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        {[
                            ...
                            { icon: <Globe className="text-[#8B5CF6]" size={24} />, title: 'Multilingual Insights', desc: 'Communication is key. Ask in any language and get insights back in English, Hindi, or Bengali.' },
                            ...
                            { icon: <Mic className="text-[#F59E0B]" size={24} />, title: 'Voice Query capabilities', desc: 'Just speak to your dataset. Integrated Azure Speech services powers seamless vocal interactions.' },
                            ...
                            { icon: <Shield className="text-[#3b82f6]" size={24} />, title: 'Secure Data Handling', desc: 'Your data is processed securely with enterprise-grade encryption and Azure SQL protection.' },
                        ].map((feat, idx) => (
